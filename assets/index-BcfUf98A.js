...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:an,depthTest:!1,depthWrite:!1})}function Sa(){return new Zt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Is(),fragmentShader:`
		...
		`,blending:an,depthTest:!1,depthWrite:!1})}function Ea(){return new Zt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Is(),fragmentShader:`
...
#define LOW_PRECISION`),e}function td(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===ka?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Fo?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Wt&&(e="SHADOWMAP_TYPE_VSM"),e}function nd(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Yn:case $n:e="ENVMAP_TYPE_CUBE";break;case ji:e="ENVMAP_TYPE_CUBE_UV";break}return e}function id(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case $n:e="ENVMAP_MODE_REFRACTION";break}return e}function rd(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Wa:e="ENVMAP_BLENDING_MULTIPLY";break;case tl:e="ENVMAP_BLENDING_MIX";break;case nl:e="ENVMAP_BLENDING_ADD";break}return e}function sd(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function ad(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=td(t),c=nd(t),u=id(t),d=rd(t),p=sd(t),m=Yf(t),x=$f(s),S=r.createProgram();let f,h,A=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(oi).join(`
`)),a=ys(a),a=Da(a,t),a=Ua(a,t),o=ys(o),o=Da(o,t),o=Ua(o,t),a=Ia(a),o=Ia(o),t.isRawShaderMaterial!==!0&&(A=`#version 300 es
